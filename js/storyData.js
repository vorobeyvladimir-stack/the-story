...
const CHAPTERS = [
  {
    ...
    lines: [
      ...
      { who: 'LYDIA', text: "Seems I’m about to discover a new side of myself." },
  ...
  },
  {
    ...
    lines: [
      ...
      { who: 'LYDIA', text: "Seems I’m about to discover a new side of myself.", page: 0, panel: 4 },
  ...
  },
  {
    ...
    ico: '🇸🇪',
    grayIco: 'assets/gray/card4_stockholm_grey.png',
    loc: 'Stockholm',
    comingSoon: true,
    chars: ['gala', 'lydia'],
    bg: 'stockholm',
  ...
  },
  {
    ...
    title: 'Home in Kyiv',
    ico: '🇺🇦',
    grayIco: 'assets/gray/card5_kyiv_grey.png',
    loc: 'Kyiv',
    comingSoon: true,
    chars: ['gala', 'lydia'],
    bg: 'kyiv',
  ...
  },
  {
    ...
    ico: '🌉',
    grayIco: 'assets/gray/card6_frankfurt_grey.png',
  ...
  },
  {
    ...
    title: 'Daily Magic',
    ico: '💬',
    grayIco: 'assets/gray/card7_groupchat_grey.png',
    loc: 'The Group Chat',
    comingSoon: true,
    chars: ['vvv', 'gala', 'lydia'],
    bg: 'chat',
